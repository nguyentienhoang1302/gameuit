...
void SpriteFactory::LoadResources()
{
	...
	sprites->AddSprite(new PlayerSprite(STANDING, 1, 30, 25, 65));
	sprites->AddSprite(new PlayerSprite(STANDING, 26, 30, 50, 65));
	sprites->AddSprite(new PlayerSprite(RUNNING, 2, 66, 23, 102));
	sprites->AddSprite(new PlayerSprite(RUNNING, 24, 66, 23, 102));
	sprites->AddSprite(new PlayerSprite(RUNNING, 42, 66, 61, 102));
	sprites->AddSprite(new PlayerSprite(RUNNING, 62, 66, 83, 102));
	sprites->AddSprite(new PlayerSprite(RUNNING, 84, 66, 101, 102));
	sprites->AddSprite(new PlayerSprite(RUNNING, 102, 66, 122, 102));
	sprites->AddSprite(new PlayerSprite(SITTING, 83, 48, 116, 65));
	sprites->AddSprite(new PlayerSprite(JUMPING, 117, 44, 134, 65));
	sprites->AddSprite(new PlayerSprite(JUMPING, 135, 44, 155, 65));
	sprites->AddSprite(new PlayerSprite(JUMPING, 156, 44, 173, 65));
	sprites->AddSprite(new PlayerSprite(JUMPING, 174, 44, 194, 65));
	sprites->AddSprite(new PlayerSprite(ATTACKING_STAND, 40, 5, 62, 38));
	sprites->AddSprite(new PlayerSprite(ATTACKING_STAND, 66, 5, 93, 38));
	sprites->AddSprite(new PlayerSprite(ATTACKING_STAND, 110, 5, 133, 38));
	sprites->AddSprite(new PlayerSprite(ATTACKING_SIT, 35, 53, 57, 76));
	...
	//Add intro sprite
	sprites->AddSprite(new Sprite(INTROSCENE, 0, 0, 256, 224));
