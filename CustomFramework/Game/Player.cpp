...
Player::Player()
{
	animations[STANDING] = new Animation(PLAYER, 0, 1, DEFAULT_TPF);
	animations[RUNNING] = new Animation(PLAYER, 2, 7, DEFAULT_TPF);
	animations[SITTING] = new Animation(PLAYER, 8, 8);
	animations[JUMPING] = new Animation(PLAYER, 9, 12, DEFAULT_TPF);
	animations[FALLING] = new Animation(PLAYER, 9, 12, DEFAULT_TPF);
	animations[ATTACKING_STAND] = new Animation(PLAYER, 9, 11, DEFAULT_TPF);
	animations[ATTACKING_SIT] = new Animation(PLAYER, 12, 14, DEFAULT_TPF);
	animations[CLINGING] = new Animation(PLAYER, 15);
	animations[CLIMBING] = new Animation(PLAYER, 15, 16, DEFAULT_TPF);
