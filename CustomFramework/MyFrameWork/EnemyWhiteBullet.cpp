...
EnemyWhiteBullet::EnemyWhiteBullet(float x, float y, bool  isBoosting, float angle, int kindBullet)
{
...
void EnemyWhiteBullet::draw(Camera* cam)
{
	pData->ppTextureArrays[kindBullet]->draw(pData->x, pData->y, cam);
}
void EnemyWhiteBullet::update()
{
