	...
	EnemySprite(bulletVector)
{
	...
	pData->ppTextureArrays[0 ] = new TextureArray("Resources\\Sprites\\Enemy" ,"bazoka","stand", 1 , 60);
	pData->ppTextureArrays[0 ] -> setAnchorPoint(0.5f, 1.0f);
	pData->ppTextureArrays[1 ] = new TextureArray("Resources\\Sprites\\Enemy" ,"bazoka","fire", 1 , 60);
...
void EnemyBazokaSprite:: loadResources()
{
	...
	temp = new TextureArray("Resources\\Sprites\\Enemy" ,"bazoka","stand", 1 , 60);
